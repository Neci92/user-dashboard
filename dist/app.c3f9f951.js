...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/modules/populateGrid.js":[function(require,module,exports) {
"use strict";
...
function populateGrid() {
  ...
  var fetchUrl = 'https://randomuser.me/api?results=10';
  fetch(fetchUrl).then(function (response) {
    return response.json();
  }).then(function (data) {
    return createCards(data.results);
  });

  function createCards(arr) {
    var content = '';
    arr.forEach(function (user) {
      content += "\n\t\t\t\t\t\t<div class=\"content__card\">\n\t\t\t\t\t\t\t<picture class=\"content__img-box\">\n\t\t\t\t\t\t\t\t<source media=\"(max-width: 768px)\" srcset=\"".concat(user.picture.thumbnail, "\">\n\t\t\t\t\t\t\t\t<source media=\"(max-width: 1200px)\" srcset=\"").concat(user.picture.medium, "\">\n\t\t\t\t\t\t\t\t<img src=\"").concat(user.picture.large, "\" alt=\"").concat(user.name.first, "\" class=\"content__img-big\">\n\t\t\t\t\t\t\t</picture>\n\t\t\t\t\t\t\t<div class=\"content__details\">\n\t\t\t\t\t\t\t\t<span class=\"content__row\">First Name: ").concat(user.name.first, "</span>\n\t\t\t\t\t\t\t\t<span class=\"content__row\">Last Name: ").concat(user.name.last, "</span>\n\t\t\t\t\t\t\t\t<span class=\"content__row\">Position: Manager</span>\n\t\t\t\t\t\t\t\t<span class=\"content__row\">Tasks: 83%</span> \n\t\t\t\t\t\t\t\t<span class=\"content__row\">Date started: 01.10.2021</span><br>\n\t\t\t\t\t\t\t\t<input type=\"file\" id=\"file\" class=\"content__upload\"> \n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t");
    });
    grid.insertAdjacentHTML('beforeend', content);
  }
}

var _default = populateGrid;
...
exports.default = _default;
},{"../dist/chart.esm":"../node_modules/chart.js/dist/chart.esm.js"}],"js/modules/newCharts.js":[function(require,module,exports) {
"use strict";
...
var ctx = document.getElementById('newPie');

function chartIt(data) {
  var chart = new _auto.default(ctx, data);
}

var _default = chartIt;
exports.default = _default;
},{"chart.js/auto":"../node_modules/chart.js/auto/auto.esm.js"}],"js/modules/charts.js":[function(require,module,exports) {
/////////////////Chart pie ///////////////////////
var myChartPie = document.getElementById('myChartPie').getContext('2d'); // Global Options

Chart.defaults.global.defaultFontSize = 18;
Chart.defaults.global.defaultFontColor = '#000';
var massPopChartPie = new Chart(myChartPie, {
  type: 'pie',
...
var myChart = document.getElementById('myChart').getContext('2d'); // Global Options
...
var _populateGrid = _interopRequireDefault(require("./modules/populateGrid"));

var _newCharts = _interopRequireDefault(require("./modules/newCharts"));
...
(0, _newCharts.default)(chartData);
(0, _populateGrid.default)();
},{"./modules/populateGrid":"js/modules/populateGrid.js","./modules/newCharts":"js/modules/newCharts.js","./modules/charts":"js/modules/charts.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
